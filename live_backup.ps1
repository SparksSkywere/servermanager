...
# Define the path to SteamCMD executable | Alter as needed
$SteamCMDPath = "D:\SteamCMD\steamcmd.exe"
$LogFilePath = "C:\servermanager\log-autoupdater.log"
...
function Send-Shutdown {
    ...
    # Define the shutdown folder and ensure it exists
    $shutdownDir = "C:\servermanager"
...
if (-not $stopFilePath) {
    ...
    Logging "Stop file path was null. Using default value: $stopFilePath."
}
...
function Update-Game {
    ...
    $stopFilePath = "C:\servermanager\stop.txt"  # Default stop file path
