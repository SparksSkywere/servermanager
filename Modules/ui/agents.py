...
from Modules.core.common import setup_module_path, setup_module_logging, get_node_url
setup_module_path()
from Modules.Database.cluster_database import get_cluster_database

try:
    from Modules.security.cluster_security import SimpleClusterManager
except ImportError:
...
class ClusterManagementDialog:
    ...
    def create_pending_requests_section(self, parent):
        ...
        self.pending_tree.column("id", width=0, stretch=False)
