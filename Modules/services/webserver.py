...
from Modules.security.web_security import (
...
class ServerManagerWebServer(ServerManagerModule):
    ...
    def _continue_init(self, args):
        ...
        try:
            from Modules.ui.analytics import AnalyticsCollector, get_prometheus_metrics, get_snmp_metrics
    ...
    def _configure_ssl(self):
        # Auto-configure SSL if certificates are available
        try:
            from Modules.security.ssl_utils import ensure_ssl_certificate
