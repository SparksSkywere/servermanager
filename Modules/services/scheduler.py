...
from Modules.core.common import setup_module_path, setup_module_logging, save_automation_settings, get_node_url
setup_module_path()
from Modules.core.server_logging import log_process_monitoring

logger: logging.Logger = setup_module_logging("Scheduler")

class SchedulerManager:
    # Runs update checks, timers, cluster sync and relies on dashboard for UI updates
    ...
    def start_timers(self):
        ...
        if self.agent_manager and self.database_sync_enabled:
            self.dashboard.root.after(30000, self.database_sync_timer)
